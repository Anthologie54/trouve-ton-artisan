...
const Artisan = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const resArtisans = await axios.get(`${process.env.REACT_APP_API_URL}/api/artisans`);
        const resCategories = await axios.get(`${process.env.REACT_APP_API_URL}/api/categories`);
